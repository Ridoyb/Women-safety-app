...
import 'package:women_safety/chat_module/single_message.dart';
import 'package:women_safety/widgets/eco_button.dart';
import 'package:women_safety/widgets/ecotextfield.dart';

import '../../chat_module/message_textfield.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 249, 4, 167),
        title: Row(
          children: [
            ClipRRect(
